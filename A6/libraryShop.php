...
//
function testDataAdd($productname,$productdesc,$productprice){
    $error = "";
        ...
        if(empty($productprice)){
            ...
            if(empty($productprice)){
                ...
                if (move_uploaded_file($_FILES['productImg']['tmp_name'], $fichero_subido)) {
                    $error = uploadData($productname,$productdesc,$productprice,$fichero_subido);
                } else {
...
//
function uploadData($productname,$productdesc,$productprice,$productimgpath){
    $error = "";
