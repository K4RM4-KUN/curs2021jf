...
function recoveryMail($mail){
    ...
    $mail->Body = '<html><body>Hola,'.$mail.'</br> Usa el link de la linea inferior para cambiar su contraseña! </br>Link:<a href="https://dawjavi.insjoaquimmir.cat/jfuentes/UF1/A5/recoverPassword.php?">aquí</a> El link sera valido durante 24 horas</body></html>';
    $mail->CharSet = 'UTF-8';
    $mail->IsHTML(true);
    if ($mail->send()){
        header("location: login.php");
