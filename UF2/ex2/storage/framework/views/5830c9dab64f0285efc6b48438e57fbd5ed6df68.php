        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        <a href='<?php echo e(route("goForm")); ?>'><button style="background-color: rgb(255,87,15); color: white;" type="button">MAKE THIS FORM</button></a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
</html><?php /**PATH /var/www/html/jfuentes/UF2/ex2/resources/views/welcome.blade.php ENDPATH**/ ?>